...
namespace Exportar
{
    internal class Correo
    {
        public void EnviarCorreo(string error)
        {
            try
            {
                var fromAddress = new MailAddress("113069@alumnouninter.mx", "Sistema Exportar"); // Reemplaza con tu correo
                ...
                var smtp = new SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential("113069@alumnouninter.mx", "Yeyo455420") // Reemplaza con tus credenciales
                };
